        ...
        <nav className='w-full shadow-md p-4 '>
            <div className='flex justify-between items-center max-w-7xl mx-auto'>
                ...
                {userName ? (
                    ...
                    <Link to='/signup' className='w/1/4 hidden md:block' >
                ...
                {/* <div className='hidden md:block'>
                    {
                        isLogin ? <div className=''>
                            <div className='flex gap-2 justify-center '>
                                <User />
                                <p>{isLogin}</p>
                                <Play className='text-gray-600 size-5 rotate-90' />
                            </div>
                        </div> : <div>
            ...
            {open && (
                <div className='justify-evenly w-1/2 text-lg flex flex-col gap-4 '>
