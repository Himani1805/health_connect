...
const ServiceSection = ({title, icon, description, buttonLink, buttonText}) => {
  return (
    <div className='flex flex-col items-center p-10 text-center text-white'>
      ...
      <a href={buttonLink}
        className='border border-white px-6 py-2 rounded-full hover:bg-white hover:text-red-500 transition-colors duration-200'
      >
        {buttonText}
      </a>
    </div>
